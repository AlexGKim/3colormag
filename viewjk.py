...
done = numpy.arange(1,5,dtype='int')
done = numpy.append(done,171)
...
axarr[0].errorbar(xrange(len(done)),mn,yerr=[sig,sig],fmt='o')
axarr[0].errorbar(xrange(len(done)),mn,yerr=[sig_m,sig_m],fmt='o')
